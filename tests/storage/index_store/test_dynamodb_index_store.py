...
from llama_index_spanish.storage.index_store.dynamodb_index_store import DynamoDBIndexStore
from llama_index_spanish.storage.kvstore.dynamodb_kvstore import DynamoDBKVStore
