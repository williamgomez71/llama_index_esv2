...
if TYPE_CHECKING:
    from llama_index_spanish.bridge.langchain import Embeddings as LCEmbeddings
...
from llama_index_spanish.embeddings.huggingface import HuggingFaceEmbedding
from llama_index_spanish.embeddings.huggingface_utils import (
    INSTRUCTOR_MODELS,
)
...
from llama_index_spanish.llms.openai_utils import validate_openai_api_key
