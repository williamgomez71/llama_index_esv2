...
from llama_index_spanish.bridge.pydantic import BaseModel, Field, root_validator
from llama_index_spanish.utils import SAMPLE_TEXT, truncate_text

if TYPE_CHECKING:
    from haystack.schema import Document as HaystackDocument
    from semantic_kernel.memory.memory_record import MemoryRecord

    from llama_index_spanish.bridge.langchain import Document as LCDocument
