...
from llama_index_spanish.bridge.pydantic import BaseModel, PrivateAttr
...
from llama_index_spanish.llm_predictor.utils import (
...
from llama_index_spanish.llms.base import LLM, ChatMessage, LLMMetadata, MessageRole
...
from llama_index_spanish.schema import BaseComponent
from llama_index_spanish.types import PydanticProgramMode, TokenAsyncGen, TokenGen
...
class LLMPredictor(BaseLLMPredictor):
    ...
    def from_dict(cls, data: Dict[str, Any], **kwargs: Any) -> Self:  # type: ignore
        ...
        if llm != "default":
            from llama_index_spanish.llms.loading import load_llm
    ...
    def _run_program(
        ...
        **prompt_args: Any,
        ...
        from llama_index_spanish.program.utils import get_program_for_llm
