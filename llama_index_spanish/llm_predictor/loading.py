from llama_index_spanish.llm_predictor.base import BaseLLMPredictor, LLMPredictor
from llama_index_spanish.llm_predictor.mock import MockLLMPredictor
from llama_index_spanish.llm_predictor.structured import StructuredLLMPredictor
from llama_index_spanish.llm_predictor.vellum.predictor import VellumPredictor
