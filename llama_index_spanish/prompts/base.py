...
if TYPE_CHECKING:
    from llama_index_spanish.bridge.langchain import BasePromptTemplate as LangchainTemplate
...
from llama_index_spanish.llms.generic_utils import messages_to_prompt, prompt_to_messages
from llama_index_spanish.prompts.prompt_type import PromptType
from llama_index_spanish.prompts.utils import get_template_vars
...
class LangchainPromptTemplate(BasePromptTemplate):
    ...
    def format_messages(
        ...
        """Format the prompt into a list of chat messages."""
        from llama_index_spanish.llms.langchain import LangChainLLM
        from llama_index_spanish.llms.langchain_utils import from_lc_messages
