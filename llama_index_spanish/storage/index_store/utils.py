from llama_index_spanish.constants import DATA_KEY, TYPE_KEY
from llama_index_spanish.data_structs.data_structs import IndexStruct
from llama_index_spanish.data_structs.registry import INDEX_STRUCT_TYPE_TO_INDEX_STRUCT_CLASS
