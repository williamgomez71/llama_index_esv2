...
from llama_index_spanish.constants import (
    DOC_STORE_KEY,
    GRAPH_STORE_KEY,
    INDEX_STORE_KEY,
    VECTOR_STORE_KEY,
)
from llama_index_spanish.graph_stores.simple import DEFAULT_PERSIST_FNAME as GRAPH_STORE_FNAME
from llama_index_spanish.graph_stores.simple import SimpleGraphStore
from llama_index_spanish.graph_stores.types import GraphStore
from llama_index_spanish.storage.docstore.simple_docstore import SimpleDocumentStore
from llama_index_spanish.storage.docstore.types import DEFAULT_PERSIST_FNAME as DOCSTORE_FNAME
from llama_index_spanish.storage.docstore.types import BaseDocumentStore
from llama_index_spanish.storage.index_store.simple_index_store import SimpleIndexStore
from llama_index_spanish.storage.index_store.types import (
    DEFAULT_PERSIST_FNAME as INDEX_STORE_FNAME,
)
from llama_index_spanish.storage.index_store.types import BaseIndexStore
from llama_index_spanish.utils import concat_dirs
from llama_index_spanish.vector_stores.simple import DEFAULT_PERSIST_FNAME as VECTOR_STORE_FNAME
from llama_index_spanish.vector_stores.simple import (
