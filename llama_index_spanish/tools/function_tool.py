...
if TYPE_CHECKING:
    from llama_index_spanish.bridge.langchain import StructuredTool, Tool
...
class FunctionTool(AsyncBaseTool):
    ...
    def to_langchain_tool(
        ...
        **langchain_tool_kwargs: Any,
        ...
        """To langchain tool."""
        from llama_index_spanish.bridge.langchain import Tool
    ...
    def to_langchain_structured_tool(
        ...
        **langchain_tool_kwargs: Any,
        ...
        from llama_index_spanish.bridge.langchain import StructuredTool
