...
from llama_index_spanish.output_parsers.selection import Answer, SelectionOutputParser
...
from llama_index_spanish.selectors.prompts import (
    DEFAULT_MULTI_SELECT_PROMPT_TMPL,
    DEFAULT_SINGLE_SELECT_PROMPT_TMPL,
    MultiSelectPrompt,
    SingleSelectPrompt,
)
from llama_index_spanish.selectors.types import BaseSelector, SelectorResult, SingleSelection
