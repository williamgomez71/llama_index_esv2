...
import llama_index_spanish
from llama_index_spanish.bridge.pydantic import BaseModel
from llama_index_spanish.callbacks.base import CallbackManager
from llama_index_spanish.embeddings.base import BaseEmbedding
from llama_index_spanish.embeddings.utils import EmbedType, resolve_embed_model
from llama_index_spanish.indices.prompt_helper import PromptHelper
from llama_index_spanish.llm_predictor import LLMPredictor
from llama_index_spanish.llm_predictor.base import BaseLLMPredictor, LLMMetadata
from llama_index_spanish.llms.base import LLM
from llama_index_spanish.llms.utils import LLMType, resolve_llm
from llama_index_spanish.logger import LlamaLogger
from llama_index_spanish.node_parser.interface import NodeParser, TextSplitter
from llama_index_spanish.node_parser.text.sentence import (
    DEFAULT_CHUNK_SIZE,
    SENTENCE_CHUNK_OVERLAP,
    SentenceSplitter,
)
from llama_index_spanish.prompts.base import BasePromptTemplate
from llama_index_spanish.schema import TransformComponent
from llama_index_spanish.types import PydanticProgramMode
...
class ServiceContext:
    ...
    def from_defaults(
        ...
        if llama_index_spanish.global_service_context is not None:
            return cls.from_service_context(
                llama_index_spanish.global_service_context,
    ...
    def from_dict(cls, data: dict) -> "ServiceContext":
        from llama_index_spanish.embeddings.loading import load_embed_model
        from llama_index_spanish.extractors.loading import load_extractor
        from llama_index_spanish.llm_predictor.loading import load_predictor
        from llama_index_spanish.node_parser.loading import load_parser
...
def set_global_service_context(service_context: Optional[ServiceContext]) -> None:
    ...
    llama_index_spanish.global_service_context = service_context
