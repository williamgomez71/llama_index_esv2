...
from llama_index_spanish.prompts import BasePromptTemplate
from llama_index_spanish.prompts.default_prompt_selectors import (
    DEFAULT_REFINE_PROMPT_SEL,
    DEFAULT_TEXT_QA_PROMPT_SEL,
    DEFAULT_TREE_SUMMARIZE_PROMPT_SEL,
)
from llama_index_spanish.prompts.default_prompts import DEFAULT_SIMPLE_INPUT_PROMPT
from llama_index_spanish.prompts.prompts import PromptTemplate
from llama_index_spanish.response_synthesizers.accumulate import Accumulate
from llama_index_spanish.response_synthesizers.base import BaseSynthesizer
from llama_index_spanish.response_synthesizers.compact_and_accumulate import (
    CompactAndAccumulate,
)
from llama_index_spanish.response_synthesizers.compact_and_refine import CompactAndRefine
from llama_index_spanish.response_synthesizers.generation import Generation
from llama_index_spanish.response_synthesizers.no_text import NoText
from llama_index_spanish.response_synthesizers.refine import Refine
from llama_index_spanish.response_synthesizers.simple_summarize import SimpleSummarize
from llama_index_spanish.response_synthesizers.tree_summarize import TreeSummarize
from llama_index_spanish.response_synthesizers.type import ResponseMode
