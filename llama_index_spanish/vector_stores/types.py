...
from llama_index_spanish.bridge.pydantic import BaseModel, StrictFloat, StrictInt, StrictStr
from llama_index_spanish.schema import BaseComponent, BaseNode, TextNode
