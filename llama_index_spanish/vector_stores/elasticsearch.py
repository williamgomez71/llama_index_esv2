...
from llama_index_spanish.vector_stores.utils import metadata_dict_to_node, node_to_metadata_dict
...
class ElasticsearchStore(VectorStore):
    ...
    def get_user_agent() -> str:
        ...
        return f"llama_index-py-vs/{llama_index_spanish.__version__}"
