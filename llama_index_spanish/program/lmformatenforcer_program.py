...
from llama_index_spanish.llms.huggingface import HuggingFaceLLM
...
from llama_index_spanish.prompts.lmformatenforcer_utils import (
...
class LMFormatEnforcerPydanticProgram(BaseLLMFunctionProgram):
    ...
    def __init__(
        ...
        if llm is None:
            try:
                from llama_index_spanish.llms import LlamaCPP
