...
from llama_index_spanish.bridge.pydantic import BaseModel, Field, create_model
...
from llama_index_spanish.types import BasePydanticProgram, PydanticProgramMode
...
def get_program_for_llm(
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        ...
        from llama_index_spanish.program.lmformatenforcer_program import (
