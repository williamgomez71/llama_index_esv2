...
from llama_index_spanish.chat_engine.types import BaseChatEngine, ChatMode
from llama_index_spanish.core import BaseQueryEngine, BaseRetriever
from llama_index_spanish.data_structs.data_structs import IndexStruct
from llama_index_spanish.ingestion import run_transformations
from llama_index_spanish.llms.openai import OpenAI
from llama_index_spanish.llms.openai_utils import is_function_calling_model
from llama_index_spanish.schema import BaseNode, Document
from llama_index_spanish.service_context import ServiceContext
from llama_index_spanish.storage.docstore.types import BaseDocumentStore, RefDocInfo
...
class BaseIndex(Generic[IS], ABC):
    ...
    def as_chat_engine(
        ...
        if chat_mode == ChatMode.CONDENSE_QUESTION:
            # NOTE: lazy import
            from llama_index_spanish.chat_engine import CondenseQuestionChatEngine
            ...
            from llama_index_spanish.chat_engine import ContextChatEngine
            ...
            from llama_index_spanish.chat_engine import CondensePlusContextChatEngine
            ...
            # NOTE: lazy import
            from llama_index_spanish.agent import OpenAIAgent, ReActAgent
            ...
            from llama_index_spanish.chat_engine import SimpleChatEngine
