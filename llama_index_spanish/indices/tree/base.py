...
from llama_index_spanish.indices.common_tree.base import GPTTreeIndexBuilder
from llama_index_spanish.indices.tree.inserter import TreeIndexInserter
...
class TreeIndex(BaseIndex[IndexGraph]):
    ...
    def as_retriever(
        ...
        **kwargs: Any,
        ...
        from llama_index_spanish.indices.tree.select_leaf_retriever import (
