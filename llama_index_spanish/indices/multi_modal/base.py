...
from llama_index_spanish.data_structs.data_structs import IndexDict, MultiModelIndexDict
from llama_index_spanish.embeddings.multi_modal_base import MultiModalEmbedding
from llama_index_spanish.embeddings.utils import EmbedType, resolve_embed_model
from llama_index_spanish.indices.utils import (
...
from llama_index_spanish.schema import BaseNode, ImageNode
...
from llama_index_spanish.vector_stores.simple import DEFAULT_VECTOR_STORE, SimpleVectorStore
...
class MultiModalVectorStoreIndex(VectorStoreIndex):
    ...
    def as_retriever(self, **kwargs: Any) -> BaseRetriever:
        # NOTE: lazy import
        from llama_index_spanish.indices.multi_modal.retriever import (
