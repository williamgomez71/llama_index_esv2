...
from llama_index_spanish.embeddings.base import similarity as default_similarity_fn
from llama_index_spanish.vector_stores.types import VectorStoreQueryMode
