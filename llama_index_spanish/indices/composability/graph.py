...
from llama_index_spanish.schema import IndexNode, NodeRelationship, ObjectType, RelatedNodeInfo
...
class ComposableGraph:
    ...
    def as_query_engine(self, **kwargs: Any) -> BaseQueryEngine:
        # NOTE: lazy import
        from llama_index_spanish.query_engine.graph_query_engine import (
