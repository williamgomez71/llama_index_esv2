...
from llama_index_spanish.embeddings.adapter import AdapterEmbeddingModel
from llama_index_spanish.embeddings.base import BaseEmbedding
from llama_index_spanish.finetuning.embeddings.common import EmbeddingQAFinetuneDataset
from llama_index_spanish.finetuning.types import BaseEmbeddingFinetuneEngine
from llama_index_spanish.utils import infer_torch_device
...
class EmbeddingAdapterFinetuneEngine(BaseEmbeddingFinetuneEngine):
    ...
    def __init__(
        ...
        **train_kwargs: Any,
        ...
        from llama_index_spanish.embeddings.adapter_utils import BaseAdapter, LinearLayer
