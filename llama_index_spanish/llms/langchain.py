...
class LangChainLLM(LLM):
    ...
    def metadata(self) -> LLMMetadata:
        from llama_index_spanish.llms.langchain_utils import get_llm_metadata

        return get_llm_metadata(self._llm)

    @llm_chat_callback()
    def chat(self, messages: Sequence[ChatMessage], **kwargs: Any) -> ChatResponse:
        from llama_index_spanish.llms.langchain_utils import (
            from_lc_messages,
            to_lc_messages,
        )
    ...
    def stream_chat(
        ...
        from llama_index_spanish.langchain_helpers.streaming import (
